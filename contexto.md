...
tags: galeria
status: not-started
hero_image: ../attachments/logo_principal.png
...
![Objeto 1](attachments/Contextofabiana.png)
...
![Objeto 1](attachments/Moodboard2.jpg)
...
![Objeto 1](attachments/contexto.jpg)

**2024265-Márcia** - Foi realizada uma análise de jogos de madeira educativos, Foram selecionados jogos tradicionais baseados na remoção de peças e na manutenção do equilíbrio de estruturas, como o _Fuera Abajo_ e outros jogos semelhantes, devido à simplicidade das suas mecânicas e à sua capacidade de criar momentos de tensão, interação social e diversão entre os jogadores.

A escolha destas referências deveu-se à proximidade entre as suas dinâmicas de jogo e os objetivos definidos para o **Oopsie Dumpty!**. A necessidade de remover elementos de uma estrutura sem provocar o seu colapso constituiu uma base adequada para desenvolver um brinquedo que incentivasse a precisão dos movimentos, a tomada de decisões e a concentração das crianças de forma intuitiva e acessível.

### 2.2. Moodboard

Painel de referências visuais e conceptuais que orientam a estratégia do grupo.

![Moodboard](attachments/MoodboardContexto.png)
